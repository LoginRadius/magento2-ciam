...
namespace LoginRadius\Ciam\Observer;
...
class EditUser implements ObserverInterface {
    ...
    \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\RequestInterface $request
    ) {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        ...
        if (isset($this->request->getPostValue()['customer']['entity_id'])) {
            $editUserData = '{
            "Email":[
               {
                  "Type":"Primary",
