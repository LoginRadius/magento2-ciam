...
namespace LoginRadius\Ciam\Observer\Frontend;
...
\Magento\Framework\App\RequestInterface $request, \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Framework\ObjectManagerInterface $objectManager
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        $this->_helperActivation = \Magento\Framework\App\ObjectManager::getInstance()->get('LoginRadius\Ciam\Model\Helper\Data');
        if ($this->_helperActivation->enableIefPage() == '1') {
